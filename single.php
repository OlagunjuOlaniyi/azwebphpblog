                            ...
                            <div class="container text-center">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        ...
                                        <p class="page-header-text">Category: <?php echo $post_category; ?>,
                        ...
                        <div class="container">
                            ...
                            <div class="pt-5 col-lg-8 col-xl-9">
                                ...
                                <?php 
                                    ...
                                    if ($count == 0) {
                                        ...
                                        while ($comment = $stmt1->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            $user_name = $comment['com_username'];
                                            ...
                                            <?php } elseif ($com_status == 'approved') { ?>
                                                <div class="card mb-5">
                                                    <div class="card-header d-flex justify-content-between">
                                                        <div class="mr-2 text-dark">
                                                            <?php echo $user_name; ?>
                                ...
                                <?php 
                                            ...
                                            <div class="card-body">
                                                <?php  
                                                    if (isset($_POST['submit'])) {
                                                        ...
                                                        $sql = "INSERT INTO comments (com_post_id, com_detail, com_user_id, com_username, com_date, com_status) VALUES (:post_id, :com_detail, :user_id, :username, :com_date, :com_status)";
                                                        $stmt = $pdo->prepare($sql);
                                    ...
                                    <?php } else {
                                        echo "<a href='./backend/signin.php'>Please signin to comment!</a>";
                                    }
                                ?>
