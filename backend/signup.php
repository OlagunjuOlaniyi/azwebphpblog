                                        ...
                                        <form action="signup.php" method="POST">
                                            <?php 
                                                if (isset($error_email_exist)) {
                                                    ...
                                                    echo "<p class='alert alert-success'>Account created successfully!
                                            ...
                                            <div class="form-group">
                                                <label class="small mb-1" for="userNickname">Nickname</label>
                                                <input name="nick-name" class="form-control py-4" id="userNickname" type="text" placeholder="Enter email address" required="true" />
                                            </div>
                                            <div class="form-group">
