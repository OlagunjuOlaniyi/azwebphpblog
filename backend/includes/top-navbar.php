    ...
    <ul class="navbar-nav align-items-center ml-auto">
        ...
        <li class="nav-item dropdown no-caret mr-3 dropdown-notifications">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownAlerts" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php 
                    if ($com_count != 0) { ?>
                        <span class="badge badge-red"><?php echo $com_count; ?></span>
                    <?php }
                ?>
            ...
            <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownMessages">
                ...
                <?php 
                    ...
                    while ($message = $stmt->fetch(PDO::FETCH_ASSOC)) {                        
                        ...
                        $ms_detail = substr($message['ms_detail'], 0, 40);
                        ...
                        $ms_user_img = $user['user_photo'];
                        ?>

                        <a class="dropdown-item dropdown-notifications-item" href="messages.php"
                            ><img class="dropdown-notifications-item-img" src="../img/<?php echo $ms_user_img ?>" />
                            <div class="dropdown-notifications-item-content">
                                <div class="dropdown-notifications-item-content-text">
                                    <?php echo $ms_detail; ?>
                                </div>
        ...
        <li class="nav-item dropdown no-caret mr-3 dropdown-user">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="img-fluid" src="./assets/img/<?php echo $user_photo; ?>"/>
            </a>
