                                            ...
                                            while ($categories = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php  
                                                            if ($category_total_post == 0) { ?>
                                                                <form accept="categories.php" method="POST">
                                                                    <input type="hidden" name="cat-id" value="<?php echo $category_id ?>">
                                                                    <button name="delete" type="submit" class="btn btn-red btn-icon" title="delete category"><i data-feather="trash-2"></i></button>
                                                                </form>
                                                            <?php } else { ?>
                                                                <button name="delete" type="submit" class="btn btn-red btn-icon" title="Can't delete category having post(s)!"><i data-feather="trash-2"></i></button>
                                                            <?php }
                                                        ?>
                                                    </td>
                                                </tr>    
